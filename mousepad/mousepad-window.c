...
static void              mousepad_window_button_close_tab             (MousepadDocument       *document,
                                                                       MousepadWindow         *window);
static gboolean          mousepad_window_configure_event              (MousepadWindow         *window,
...
mousepad_window_init (MousepadWindow *window)
{
  ...
  /* signal for handling the window configure event */
  g_signal_connect (G_OBJECT (window), "configure-event",
                    G_CALLBACK (mousepad_window_configure_event), NULL);
...
static gboolean
mousepad_window_configure_event (MousepadWindow    *window,
                                 GdkEventConfigure *event)
{
  ...
  source_id = g_timeout_add (1000, G_SOURCE_FUNC (mousepad_window_save_geometry), window);
