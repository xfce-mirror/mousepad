                                   ...
                                   gint           *offset)
{
  ...
  mousepad_object_set_data (G_OBJECT (model), "gtkmenu", menu);
  mousepad_object_set_data (G_OBJECT (model), "offset", GINT_TO_POINTER (*offset));
...
mousepad_window_menu_tab_sizes_update (MousepadWindow *window)
{
  ...
  gtkmenu = mousepad_object_get_data (G_OBJECT (model), "gtkmenu");
  offset = GPOINTER_TO_INT (mousepad_object_get_data (G_OBJECT (model), "offset"));
