  ...
  if (info == TARGET_TEXT_URI_LIST
      ...
      && gtk_selection_data_get_length (selection_data) > 0)
    {
      ...
      mousepad_window_open_files (window, (GFile **) data, n_pages,
                                  ...
                                  DEFAULT_LINE, DEFAULT_COLUMN, TRUE);
  ...
  if (G_LIKELY (filename != NULL))
    {
      ...
      result = mousepad_file_open (document->file, DEFAULT_LINE, DEFAULT_COLUMN, TRUE, FALSE, FALSE, &error);
  ...
  if (G_LIKELY (mousepad_dialogs_open (GTK_WINDOW (window),
                ...
                == GTK_RESPONSE_ACCEPT))
    {
      ...
      for (file = files; file != NULL; file = file->next)
        mousepad_window_open_file (window, file->data, encoding, DEFAULT_LINE, DEFAULT_COLUMN, TRUE);
      ...
      if (G_LIKELY (uri != NULL))
        {
          ...
          file = g_file_new_for_uri (uri);
          succeed = mousepad_window_open_file (window, file, encoding, DEFAULT_LINE, DEFAULT_COLUMN, TRUE);
          g_object_unref (file);
                               ...
                               gpointer       data)
{
  ...
  /* reload the file */
  retval = mousepad_file_open (document->file, DEFAULT_LINE, DEFAULT_COLUMN, TRUE, FALSE, FALSE, &error);
