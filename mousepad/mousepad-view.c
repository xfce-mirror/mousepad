...
#define MOUSEPAD_VIEW_DEFAULT_FONT "Monospace 14"
                            ...
                            GParamSpec *pspec)
{
  ...
  switch (prop_id)
    {
    case PROP_FONT_NAME:
      g_value_set_string (value, pango_font_description_to_string (view->font_desc));
      break;
    case PROP_SHOW_WHITESPACE:
...
mousepad_view_update_font (MousepadView *view)
{
  ...
  /* update font */
  css_string = g_strdup_printf ("textview { font: %dpx %s; }",
