...
#ifdef HAVE_GSPELL
static void      mousepad_view_set_gspell_buffer             (MousepadView        *view);
#endif
...
mousepad_view_set_gspell_buffer (MousepadView *view)
{
  ...
  gspell_text_buffer_set_spell_checker (view->gspell_buffer,
                                        view->spell_check ? view->gspell_checker : NULL);
}
