...
gchar              **mousepad_application_get_languages_tooltips     (MousepadApplication  *application);

gchar              **mousepad_application_get_style_schemes_tooltips (MousepadApplication  *application);
