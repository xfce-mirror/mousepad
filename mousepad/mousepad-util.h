...
GtkSourceLanguage *mousepad_util_recent_get_language              (const gchar                *uri);

MousepadEncoding   mousepad_util_recent_get_encoding              (const gchar                *uri);

void               mousepad_util_recent_clear                     (void);

void               mousepad_util_recent_bind_disabled             (void);
