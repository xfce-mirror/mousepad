                                     ...
                                     GError      **error)
{
  ...
  mousepad_object_set_data (application, "user_set_encoding", GINT_TO_POINTER (user_set_encoding));
                                           ...
                                           GVariantDict *options)
{
  ...
  g_variant_dict_insert (options, "user_set_encoding", "b",
    GPOINTER_TO_INT (mousepad_object_get_data (application, "user_set_encoding")));
                                   ...
                                   GApplicationCommandLine *command_line)
{
  ...
  g_variant_dict_lookup (options, "user_set_encoding", "b", &user_set_encoding);
      ...
      for (n = 0; n < n_files; n++)
        {
          ...
          mousepad_object_set_data (file, "user_set_encoding",
