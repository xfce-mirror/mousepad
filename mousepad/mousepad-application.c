...
static const GActionEntry setting_actions[] =
{
  ...
  whitespace_actions[0], whitespace_actions[1], whitespace_actions[2],
...
mousepad_application_startup (GApplication *gapplication)
{
  ...
  for (n = 0; n < N_WHITESPACE; n++)
    {
      /* associate a flag to the action */
      action = g_action_map_lookup_action (G_ACTION_MAP (application), whitespace_actions[n].name);
