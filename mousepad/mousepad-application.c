  ...
  for (n = 0; n < N_SETTING; n++)
    {
      ...
      g_action_group_change_action_state (G_ACTION_GROUP (application), setting_actions[n].name,
                                          mousepad_setting_get_variant (setting_actions[n].name));
    }
                                    ...
                                    GSettings           *settings)
{
  ...
  g_action_group_change_action_state (G_ACTION_GROUP (application), action_name,
                                      mousepad_setting_get_variant (action_name));
