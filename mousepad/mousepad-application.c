      ...
      for (n = 0; n < n_toggle_actions[m]; n++)
        {
          ...
          mousepad_setting_connect_object (toggle_actions[m][n].name,
                                           G_CALLBACK (mousepad_application_toggle_update),
          ...
          if (mousepad_setting_has_setting (toggle_actions[m][n].name))
            {
              state = mousepad_setting_get_boolean (toggle_actions[m][n].name);
                                    ...
                                    GSettings           *settings)
{
  ...
  state = mousepad_setting_get_boolean (action_name);
  g_action_group_change_action_state (G_ACTION_GROUP (application),
